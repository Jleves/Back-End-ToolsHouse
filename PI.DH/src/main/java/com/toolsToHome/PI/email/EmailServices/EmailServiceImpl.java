package com.toolsToHome.PI.email.EmailServices;
...
import static com.toolsToHome.PI.email.utils.EmailUtils.getEmailMessage;
import static com.toolsToHome.PI.email.utils.EmailUtils.getVerificationUrl;
...
public class EmailServiceImpl  {
    ...
    public void sendMimeMessageWithEmbeddedFiles(String name, String to, String token) {
        try {
            ...
            FileSystemResource dog = new FileSystemResource(new File(System.getProperty("user.home") + "/Downloads/images/dog.jpg"));
            FileSystemResource homework = new FileSystemResource(new File(System.getProperty("user.home") + "/Downloads/images/homework.docx"));
            helper.addInline(getContentId(fort.getFilename()), fort); //agregamos imagen
